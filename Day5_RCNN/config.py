...
T_decay_rate=0.99
T_weights_file =r'./output/train_alexnet/save.ckpt-400' #这里要改成个自己相同的数据
...
F_weights_file =r'./output/fineturn/save.ckpt-54000' # 仅在预测的时候用得到
...
R_decay_rate=0.5
R_weights_file =r'./output/Reg_box/save.ckpt-10000' # 仅在预测的时候用得到